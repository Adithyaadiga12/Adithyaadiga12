...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=28&duration=3000&pause=1000&color=7C3AED&center=true&vCenter=true&width=600&lines=Hey%2C+I'm+Adithya+%F0%9F%91%8B;AI+Engineer+in+the+making;Building+with+LLMs+%26+RAG;Python+%7C+FastAPI+%7C+Vectors" alt="Typing SVG" />

<br/>

<p><em>Recent grad turning curiosity about AI into real things — RAG pipelines, LLM apps, Python backends.</em></p>

<!-- Social badges -->
<a href="mailto:adithyaadiga21@gmail.com">
...
- 🤖 **LLM-powered apps** — prompt engineering, tool use, agents
- ⚡ **Python backends** — FastAPI, async, REST & streaming APIs
- 📦 Moving AI projects from prototype → production
...
- MLOps basics — versioning, monitoring, deployment
